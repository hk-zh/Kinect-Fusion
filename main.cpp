...
//    for (int i = 0; i < number_of_frames; ++i) {
        sensor.processNextFrame();
//        volume.get_current_info(sensor, vertex_current.get(), normal_prediction.get());
//        if (i != 0) {
//            volume.icp(vertex_current.get(), normal_current.get(), vertex_prediction.get(), normal_prediction.get(), currentPos);
//        }
